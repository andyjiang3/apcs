...
public class StringPractice
{
    public static void main(String[ ] args)
    {
        ...
        int indexOfSpace = oldString.indexOf(" ");
        System.out.println("Index of Space: " + indexOfSpace);
        System.out.println(oldString.substring(0,3) + "be");
        String to = oldString.substring(0,indexOfSpace);
        System.out.println("Word: " + to + "be");
